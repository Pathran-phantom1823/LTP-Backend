...
public class AgencyProfileController {
    ...
    public ResponseEntity<Object> createAgencyProfile(@RequestPart(value = "data") String data,
        ...
        agencyProfileModel.setEmail(entity.getEmail());
    ...
    public ResponseEntity<?> postMethodName(@RequestBody AgencyProfileModel entity) {
    ...
    public ResponseEntity<Object> updateAgencyProfilewithImage(@RequestPart(value = "data") String data,
            @RequestPart(value = "img") final MultipartFile img) throws IOException, ResourceNotFoundException {
                ...
                AgencyProfileModel agencyProfileModel = agencyProfileRepository.findById(entity.getId()).orElseThrow(() -> new ResourceNotFoundException("not found"));
                AddressModel addressModel = addressRepository.findById(entity.getAddressId()).orElseThrow(() -> new ResourceNotFoundException("not found"));
                SkillsModel skillsModel = skillsRepository.findById(entity.getSkillId()).orElseThrow(() -> new ResourceNotFoundException("not found"));
                CategoryModel categoryModel = categoryRepository.findById(entity.getCategoryId()).orElseThrow(() -> new ResourceNotFoundException("not found"));
    ...
    public ResponseEntity<Object> updateAgencyProfile(@RequestPart(value = "data") String data) throws IOException, ResourceNotFoundException {
